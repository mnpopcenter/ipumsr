...
[![Coverage Status](https://img.shields.io/codecov/c/github/mnpopcenter/ripums/master.svg)](https://codecov.io/github/mnpopcenter/ripums?branch=master)
...
## Vignettes ##
Once you have the package installed, it should have included the vignettes,
which you can access via the command:
```{r, eval = FALSE}
# To list them
library(ripums)
...
### ripumsexamples ###
Example extracts for the CPS and NHGIS vignettes are too big to fit in the main
package, but are included in the 'ripumsexamples' package, which can be
